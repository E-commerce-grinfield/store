...
export function Header() {
  return (
    <div className="text-black text-2xl font-bold leading-normal tracking-wide border-b-gray-500 border-b-[1px] flex pt-[40px] pb-[16px]  px-[5px]">
      <div className="flex items-center gap-[160px]  max-w-[1160px] mx-auto">
        <div className="Exclusive text-black text-2xl font-bold font-['Inter'] leading-normal tracking-wide">
          Exclusive
        </div>
        <div className="flex gap-[48px]">
          ...
          <div className="w-16 h-6 justify-center items-center inline-flex">
            <a href="/signup">
              <div className="text-center text-black text-base font-normal leading-normal whitespace-nowrap">
                Sign Up
              </div>
            </a>
          </div>
