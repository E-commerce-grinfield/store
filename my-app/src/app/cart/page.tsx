...
export default  function Cart() {
  ...
  return (
    ...
    <div>
    <div  style={{ marginLeft:"-130px"  }} className="w-60 h-90 px-0 py-4  rounded justify-center items-center gap-2.5 inline-flex">{name}</div>
{/*    <div style={{ marginLeft:"-80px"  }} className="text-red-500 text-base font-medium leading-normal">{price}$</div>*/}

      
        <div style={{marginLeft:"130px" , marginTop:"0px"}}  className="opacity-50 text-black text-sm font-normal font-['Poppins'] leading-tight">Cart</div>
        <Link href="/">
...
/>      <div className="flex-col justify-start items-start inline-flex">
  ...
  <div className="w-14 h-14 px-0.5 pt-2 pb-1.5 left-[40px] top-[24px] absolute justify-center items-center inline-flex">
    <img className="w-12 h-10" src={JSON.parse(prod).image} />
  </div>
...
<input style={{marginLeft:"400px",  marginTop:"70px"}}
  ...
  <div className="text-neutral-50 text-base font-medium font-['Poppins'] leading-normal">Apply Coupon</div>
  </div>
</div>
</div>
...
<div className=" relative rounded ">
  <div className="left-[24px] top-[32px] absolute text-black text-xl font-medium font-['Poppins'] leading-7">Cart Total</div>
  ...
  <div className="left-[24px] top-[140px] absolute justify-start items-start gap-80 inline-flex">
    <div className="text-black text-base font-normal font-['Poppins'] leading-normal">Shipping:</div>
    <div className="text-black text-base font-normal font-['Poppins'] leading-normal">Free</div>
  </div>
  ...
  <div className="px-12 py-4 left-[89px] top-[236px] absolute bg-red-500 rounded justify-center items-center gap-2.5 inline-flex">
    <button className="text-neutral-50 text-base font-medium font-['Poppins'] leading-normal">Procees to checkout</button>
  </div>
