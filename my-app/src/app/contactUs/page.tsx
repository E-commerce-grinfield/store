  ...
  <div className="self-stretch flex-col justify-start items-end gap-8 inline-flex">
    <div className="justify-start items-start gap-4 inline-flex">
      <div className="w-60 h-12 relative">
        <input className="w-60 h-12 left-0 top-0 absolute bg-neutral-100 rounded"></input>
      ...
      <div className="w-60 h-12 relative">
        <input className="w-60 h-12 left-0 top-0 absolute bg-neutral-100 rounded"></input>
        <div className="left-[16px] top-[13px] absolute opacity-10"><span className="text-black text-base font-normal leading-normal">Your Phone </span><span className="text-red-500 text-base font-normal leading-normal">*</span></div>
      </div>
    </div>
    <div className="w-96 h-52 relative">
      <input className="w-96 h-52 left-0 top-0 absolute bg-neutral-100 rounded"></input>
